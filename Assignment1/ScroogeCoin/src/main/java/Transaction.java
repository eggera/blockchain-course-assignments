...
public class Transaction {
    ...
    /**
     * Prepare byte array (message) of a particular input and ALL outputs to sign
     * - produce bytecode for a transaction given as a specific input
     * - add ALL outputs (!)
     *      -> probably not all outputs are related to that input (?)
     * @param index
     * @return
     */
    ...
    /**
     * This method adds a new signature to an input with the given index
     * @param signature
     * @param index
     */
    ...
    /**
     * Prepare the byte code for hashing of all input and output data
     * Once this data is signed ALL transactions within that block are finalized
     * @return
     */
    ...
    /**
     * Finalize this block by getting the raw byte code of this transaction
